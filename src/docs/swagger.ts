  ...
  definition: {
    ...
    components: {
      ...
      schemas: {
        ...
        UpdateEventRequest: { type: "object", properties: { name: { type: "string" }, title: { type: "string" }, startDate: { type: "string", format: "date-time" }, endDate: { type: "string", format: "date-time" }, location: { type: "string" }, venue: { type: "string" }, participantLimit: { type: "integer", minimum: 0 }, description: { type: "string" }, category: { type: "string" }, organizerName: { type: "string" }, organizerEmail: { type: "string", format: "email" }, organizerPhone: { type: "string" } } },
        UpdateClubRequest: { type: "object", properties: { email: { type: "string", format: "email" }, phone: { type: "string" }, address: { type: "string" }, city: { type: "string" }, region: { type: "string" }, logoUrl: { type: "string", format: "uri" } } },
        CreatePenaltyRequest: { type: "object", required: ["type","reason","severity"], properties: { type: { type: "string", enum: ["Warning","Fine","Restriction","Suspension"] }, reason: { type: "string", minLength: 3, maxLength: 2000 }, severity: { type: "string", enum: ["low","medium","high"] } } },
    ...
    paths: {
      ...
      "/users/{id}": { patch: { tags: ["Admin — Users"], summary: "Update user details", description: "Updates user name, phone, role, permissions, and enabled status.", security: [{ bearerAuth: [] }], parameters: [{ in: "path", name: "id", required: true, schema: { type: "string" } }], requestBody: { required: true, content: { "application/json": { schema: { $ref: "#/components/schemas/UpdateUserRequest" } } } }, responses: { 200: { description: "User updated", content: { "application/json": { schema: { type: "object", properties: { success: { type: "boolean" }, message: { type: "string" }, data: { $ref: "#/components/schemas/UserPublic" } } } } } }, 404: { description: "Not found", content: { "application/json": { schema: { $ref: "#/components/schemas/Error" } } } } } } },
      // ── Entity Updates ──────────────────────────
      ...
      "/clubs/{id}": { patch: { tags: ["Clubs"], summary: "Update club details", description: "Partially update a clubs profile fields.", security: [{ bearerAuth: [] }], parameters: [{ in: "path", name: "id", required: true, schema: { type: "string" } }], requestBody: { required: true, content: { "application/json": { schema: { $ref: "#/components/schemas/UpdateClubRequest" } } } }, responses: { 200: { description: "Club updated", content: { "application/json": { schema: { type: "object", properties: { success: { type: "boolean" }, message: { type: "string" }, data: { $ref: "#/components/schemas/ClubProfile" } } } } } }, 404: { description: "Not found", content: { "application/json": { schema: { $ref: "#/components/schemas/Error" } } } } } } },
